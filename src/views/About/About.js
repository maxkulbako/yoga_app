  ...
  return (
    <div className="about_contant_wrapper">
      <div className="img_wrapper">
        <img alt="ava_img" src="https://res.cloudinary.com/dd69ztxsd/image/upload/v1677590264/nana_yoga/IMG_2448_m2cw1o.jpg" />
      </div>
      <div className="text_section_wrapper">
        <div className="text_block">
          <p>
            Если вы ощущаете необходимость выдохнуть,
            расслабиться и отпустить - эта практика идеально подойдет.
            Услышать тело, замедлиться и провести 30 минут наедине с собой.
            Без лишнего напряжения, свободная и легкая, эта практика приблизит
            вас к вам же.
          </p>
          <p>
            Оставьте все ненужное за пределами коврика,
            это время только для себя.
          ...
          <p>
            ...
            еженедельно.
            Приобретая доступ к группе, Вы так же имеете возможность
            добавиться в телеграм-чат, где мы делимся полезной информацией
            о йоге и общаемся с участниками.
          </p>
          <p>
