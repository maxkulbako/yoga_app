    ...
    <div className="page_container">
      ...
      <div className="page_text_block">
        <p>
          ...
          ровести 30 минут наедине с собой.
          Без лишнего напряжения, свободная и легкая, эта практика приблизит вас к вам же.
        </p>
        <p>
        ...
        <p>
          Приглашаем в закрытую онлайн-группу,
          если есть запрос практиковать чаще и на постоянной основе.
          В группе есть более 120 практик с Наной в записи.
          Разной длительности и уровня. И две прямых трансляции еженедельно.
          Приобретая доступ к группе, Вы так же имеете возможность
          добавиться в телеграм-чат, где мы делимся полезной
